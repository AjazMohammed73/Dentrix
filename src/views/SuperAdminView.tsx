...
export const SuperAdminView: React.FC<SuperAdminViewProps> = ({ onOpenOnboardModal, onNavigateHome }) => {
  ...
  const totalMRR = allTenants
    ...
    .reduce((sum, t) => sum + (t.subscription?.monthlyFee || (t.plan === 'Enterprise' ? 11999 : t.plan === 'Professional' ? 7999 : 2999)), 0);
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setSubFormData({
                        ...
                        monthlyFee: e.target.value === 'Starter' ? 2999 : e.target.value === 'Professional' ? 7999 : 11999,
